var req_url = getRequestUrl();
var req_uri = '/'+getRequestUri()+'/';
var req_uri_root = 'hz/';
/**
 *  功能描述		: 获取访问路径地址 比如：https://localhost:8080/sgpmss/
 *  输入参数		: 无
 *  输出参数	    : 路径地址
 */
...
function getRequestUri(){
	req_uri = ''
	if(req_uri == ''){
		req_uri = document.location.pathname;
		var tmppath = req_uri.substring(0,1);
		if(tmppath == '/') {
			req_uri = req_uri.substring(1);
		}
		req_uri = req_uri.substring(0,req_uri.indexOf('/'));
	}
	return req_uri;	
}
function getRequestUrl(){
		...
		if(requestUrl == ''){
			...
			requestUrl = document.location.protocol +"//"+ document.location.host + '/' + pathname + '/';	
		}
		return requestUrl;	
}
